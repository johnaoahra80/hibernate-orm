...
public class CustomerNonEmbedded implements Serializable {
    ...
    protected CustomerNonEmbedded() {
    }

    public CustomerNonEmbedded(String first, String last, Address address) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        return id == ((CustomerNonEmbedded) o).id;
    }
