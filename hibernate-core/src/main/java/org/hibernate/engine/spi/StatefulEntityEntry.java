 ...
 */
public final class StatefulEntityEntry implements Serializable, EntityEntry {
	 ...
	 * </pre>
	 * Use {@link #setCompressedValue(StatefulEntityEntry.EnumState, Enum)},
	 * {@link #getCompressedValue(StatefulEntityEntry.EnumState, Class)} etc
