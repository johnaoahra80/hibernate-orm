...
public class CustomerEmbeddedEnhanced implements Serializable {
    ...
    protected CustomerEmbeddedEnhanced() {
    }

    public CustomerEmbeddedEnhanced(String first, String last, Address address) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        return id == ((CustomerEmbeddedEnhanced) o).id;
    }
